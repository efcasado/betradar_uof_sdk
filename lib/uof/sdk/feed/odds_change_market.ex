defmodule UOF.SDK.Feed.OddsChangeMarket do
  @moduledoc false
  use Ecto.Schema
  ...
  embedded_schema do
    ...
    embeds_one(:market_metadata, UOF.SDK.Feed.MarketMetadata)
    embeds_many(:outcome, UOF.SDK.Feed.OddsChangeMarketOutcome)
  end
