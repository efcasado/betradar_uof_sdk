defmodule UOF.SDK.Feed.SportEventStatus do
  @moduledoc false
  use Ecto.Schema
  ...
  embedded_schema do
    ...
    embeds_one(:clock, UOF.SDK.Feed.Clock)
    embeds_one(:period_scores, UOF.SDK.Feed.Periodscores)
    embeds_one(:results, UOF.SDK.Feed.Results)
    embeds_one(:statistics, UOF.SDK.Feed.Statistics)
  end
